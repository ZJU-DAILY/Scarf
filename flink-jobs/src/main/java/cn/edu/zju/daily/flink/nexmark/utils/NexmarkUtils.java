...
public class NexmarkUtils {
    ...
    public enum RateShape {
        ...
        /**
         * Return inter-event delay, in microseconds, for each generator to follow in order to
         * achieve {@code rate} at {@code unit} using {@code numGenerators}.
         */
        ...
        /**
         * Return array of successive inter-event delays, in microseconds, for each generator to
         * follow in order to achieve this shape with {@code firstRate/nextRate} at {@code unit}
         * using {@code numGenerators}.
         */
                ...
                case SINE:
                    {
                        ...
                        for (int i = 0; i < N; i++) {
                            ...
                            interEventDelayUs[i] =
                                    unit.rateToPeriodUs(Math.round(rate)) * numGenerators;
                        }
                        return interEventDelayUs;
                    }
            }
        ...
        /**
         * Return delay between steps, in seconds, for result of {@link #interEventDelayUs}, so as
         * to cycle through the entire sequence every {@code ratePeriodSec}.
         */
