...
public class NexmarkConfiguration implements Serializable {
    ...
    @JsonProperty public String eventRates = "200000000";
    ...
    @JsonProperty public int rateIntervalSec = 1024768;
    ...
    @JsonProperty public long baseTime = 0;
    ...
    public boolean equals(Object o) {
        ...
        return numEvents == that.numEvents
                ...
                && eventRates.equals(that.eventRates)
                && rateIntervalSec == that.rateIntervalSec
