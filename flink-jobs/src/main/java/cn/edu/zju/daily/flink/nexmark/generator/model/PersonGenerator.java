...
import static cn.edu.zju.daily.flink.nexmark.generator.model.StringsGenerator.nextExtra;
import static cn.edu.zju.daily.flink.nexmark.generator.model.StringsGenerator.nextString;

import cn.edu.zju.daily.flink.nexmark.generator.NexmarkGeneratorConfig;
import cn.edu.zju.daily.flink.nexmark.model.Person;
...
public class PersonGenerator {
    ...
    /**
     * Keep the number of states small so that the example queries will find results even with a
    ...
    private static final List<String> FIRST_NAMES =
            Arrays.asList(
                    "Peter,Paul,Luke,John,Saul,Vicky,Kate,Julie,Sarah,Deiter,Walter".split(","));

    private static final List<String> LAST_NAMES =
            Arrays.asList(
                    "Shultz,Abrams,Spencer,White,Bartels,Walton,Smith,Jones,Noris".split(","));
    ...
    public static Person nextPerson(
        ...
        long id = lastBase0PersonId(config, nextEventId) + NexmarkGeneratorConfig.FIRST_PERSON_ID;
    ...
    public static long nextBase0PersonId(
            long eventId, SplittableRandom random, NexmarkGeneratorConfig config) {
     ...
     */
    public static long lastBase0PersonId(NexmarkGeneratorConfig config, long eventId) {
