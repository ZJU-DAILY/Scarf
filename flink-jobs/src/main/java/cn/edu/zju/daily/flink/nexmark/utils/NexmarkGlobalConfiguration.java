...
/**
 * Global configuration object for Flink Nexmark. Similar to Java properties configuration objects
 * it includes key-value pairs which represent the framework's configuration.
 */
@Internal
