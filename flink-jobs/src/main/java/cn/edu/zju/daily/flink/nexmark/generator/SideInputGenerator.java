 ...
 * data by id.
 *
 * <p>Generated data covers the range {@code [0, sideInputRowCount)} so lookup joins on any desired
 * id field can be modeled by looking up {@code id % sideInputRowCount}.
 */
public class SideInputGenerator {

    private static final Option PATH =
            new Option("p", "path", true, "absolute path of the side input file.");

    private static final Option ROW_COUNT =
            new Option("n", "num", true, "row count of side input.");
